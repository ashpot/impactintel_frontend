...
const Footer = () => {
  return (
    <footer className="bg-bg-dark font-lato">
      <div
      ...
      >
        <div className="mx-auto max-w-[90%] md:global-p pt-20 pb-8 text-text-muted">
          {/* Main footer grid */}
          <div className="grid xl:grid-cols-12 gap-8 mb-12">
            ...
            <div className="col-span-12 md:col-span-4">
              ...
              <p className="mt-5 md:text-lg text-sm leading-relaxed max-w-xs">
            ...
            {/* Links columns — 1 col on mobile, 3 cols on sm+ */}
            <div className="col-span-12 md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-8 text-text-muted">
              {footerLinks.map(({ heading, links }) => (
                <div key={heading}>
                  <h4 className="text-text-on-dark md:text-base text-sm font-medium uppercase mb-5">
                    {heading}
                  </h4>
