...
import { UploadsIcon } from "../ui/SvgLib"

const Drop = () => {
  return (
    <div className="grid rounded-2xl bg-dashboard-bg border border-border-secondary min-h-95 p-8">
        <div className="flex flex-col rounded-xl border-2 border-dashed border-[#C5C6C7] items-center justify-center gap-4 bg-bg-main">
            <Button variant="ghost" className="rounded-full bg-nav-active p-5">
                <UploadsIcon className="text-brand-primary w-8 h-8"/>
            </Button>
            ...
            <Button variant="primary" className="px-9 py-2.5 text-sm font-semibold">
                Browse files
            </Button>
        </div>
    </div>
